...
import { asyncAddInternship, asyncGetResume } from '../../../../store/Actions/resumeAction';
...
const AddInternship = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(asyncAddInternship({ Company: company, From: from,To:to,Position:position,Desc:desc }));
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md z-10 w-96">
        <h1 className="text-3xl font-semibold mb-6 text-gray-800">Add Internship</h1>
